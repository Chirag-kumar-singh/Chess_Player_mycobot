...
position_map = {
    "11": [-4, -71, -8, -1, -1, 40],
    "21": [3, -67, -14, -2, -1, 49],
    "31": [6.28, -66.59, -11.82, -3.0, 1.7, 48.92],
    "41": [4.28, -69.59, -12.82, 1.0, 7.7, 53.92],
    "51": [9.28, -65.59, -20.82, 5.0, 7.7, 47.92],
    "61": [19.28, -64.59, -21.82, 5.0, 3.7, 60.92],
    "71": [31.28, -44.54, -65.06, 33.85, -8.43, 72.96],
    "81": [30.91, -50.17, -55.65, 31.92, -1.61, 72.57],
    "12": [-7.13, -64.46, -20.56, 0.16, -0.17, 37.7],
    "22": [-0.13, -61.46, -25.56, 1.16, -0.17, 37.7],
    "32": [5.87, -61.46, -26.56, -1.84, -0.17, 49.7],
    "42": [12.87, -61.46, -23.56, -4.84, -1.17, 58.7],
    "52": [20.87, -52.46, -41.56, 6.16, -3.17, 65.7],
    "62": [21.28, -56.59, -36.82, 7.0, 3.7, 64.92],
    "72": [28.28, -55.59, -36.82, 7.0, 0.7, 73.92],
    "82": [30.49, -75.33, 2.6, -16.01, 4.7, 71.03],
    "13": [-9.13, -42.46, -67.56, 28.16, 0.83, 37.7],
    "23": [-1.13, -30.46, -90, 43.16, -1.17, 41.7],
    "33": [5.87, -30.46, -90, 40.16, -1.17, 48.7],
    "43": [13.87, -30.46, -90, 38.16, -2.17, 55.7],
    "53": [19.87, -28.46, -90, 37.16, -2.17, 64.7],
    "63": [27.98, -29.35, -90, 37.89, -3.81, 72.07],
    "73": [28.28, -49.59, -46.82, 7.0, 3.7, 73.92],
    "83": [35.28, -52.59, -41.82, 6.0, 2.7, 79.92],
    "14": [-9.13, -34.46, -79.56, 28.16, 0.83, 37.7],
    "24": [-1.13, -29.46, -89.56, 33.16, -0.17, 43.7],
    "34": [6.87, -29.46, -90, 32.16, -1.17, 49.7],
    "44": [12.87, -29.46, -88, 30.16, -1.17, 59.7],
    "54": [19.87, -25.46, -95, 34.16, 1.83, 65.7],
    "64": [27.98, -24.35, -97, 37.89, 0.19, 72.07],
    "74": [28.28, -47.59, -52.82, 4.0, 7.7, 73.92],
    "84": [34.28, -37.59, -70.82, 19.0, 6.7, 79.92],
    "15": [-10.13, -30.46, -83.56, 25.16, -0.17, 35.7],
    "25": [0.87, -29.46, -88, 25.16, -2.17, 46.7],
    "35": [9.87, -29.46, -87, 22.16, -3.17, 53.7],
    "45": [15.87, -29.46, -88, 22.16, -1.17, 59.7],
    "55": [22.87, -29.46, -89, 20.16, -0.17, 86.7],
    "65": [29.98, -16.35, -110, 39.89, 1.19, 75.07],
    "75": [37.98, -17.35, -106, 37.89, 0.19, 84.07],
    "85": [37.28, -29.59, -87.82, 26.0, 6.7, 81.92],
    "16": [-10.13, -32.46, -83, 19.16, -2.17, 35.7],
    "26": [0.87, -27.46, -88.5, 17.16, -2.17, 46.7],
    "36": [6.87, -31.46, -86.5, 16.16, -0.17, 53.7],
    "46": [13.87, -28.46, -88, 15.16, 1.83, 61.7],
    "56": [28.87, -25.46, -90, 14.16, -0.17, 68.7],
    "66": [26.87, -29.46, -90, 19.16, 6.83, 70.7],
    "76": [44.98, -12.35, -115, 38.89, 1.19, 88.07],
    "86": [40.28, -21.59, -100.82, 32.0, 8.7, 88.92],
    "17": [-10.13, -33.46, -82.44, 12.16, -4.17, 35.7],
    "27": [0.0, -0.35, -130, 43.45, -2.86, 45.35],
    "37": [13.0, 3.65, -134, 40.45, -2.86, 57.35],
    "47": [23.0, 5.65, -136, 41.45, -1.86, 67.35],
    "57": [31.0, 5.65, -136, 41.45, 0.14, 74.35],
    "67": [42.0, 5.65, -136, 41.45, -0.86, 85.35],
    "77": [52.0, 4.65, -136, 44.45, -2.86, 98.35],
    "87": [60.0, 4.65, -139, 51.45, -2.86, 103.35],
    "18": [-10.0, 8.65, -140, 44.45, -2.86, 34.35],
    "28": [0.0, 5.65, -142, 46.45, -2.86, 45.35],
    "38": [15.0, 13.65, -140, 33.45, -2.86, 59.35],
    "48": [32.0, 14.65, -143, 33.45, -1.86, 78.35],
    "58": [40.0, 14.65, -141, 32.45, -0.86, 85.35],
    "68": [65.0, 24.65, -145, 25.45, -4.86, 111.35],
    "78": [69.0, 35.65, -150, 25.45, -1.86, 114.35],
    "88": [69.0, 10.65, -137, 37.45, -0.86, 113.35],
    "camera": [32.12, -7.47, -52.38, -20.74, 2.81, 75.43],
}
...
def index_to_chess(r, c):
    file = chr(ord('h') - c)   # reverse columns
    rank = str(r + 1)          # reverse rows
    return file + rank
...
def go_back(mc, current_angles):
    ...
    safe[1] += 10
    mc.send_angles(clamp(safe),   SPEED); time.sleep(2)
    mc.send_angles(BACK_POSITION, SPEED); time.sleep(3)
    ...
    while True:
        ...
        if key == 'n':
            ...
            if previous_grid is None:
                ...
                print("FEN:", fen)
                if debug_img is not None:
                    cv2.imwrite(os.path.join(DEBUG_DIR, "move_000_initial.jpg"), debug_img)
            ...
            print("FEN:", fen)
            save_move_debug(move_count, white_move, black_move, current_grid, debug_img, fen)

            board_grid    = current_grid.copy()
            previous_grid = current_grid.copy()

            current_angles = go_back(mc, list(position_map['camera']))
            current_angles = execute_chess_move(mc, current_angles, black_move, board_grid)
            continue
